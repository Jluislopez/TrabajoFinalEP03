$(function()
{
	...
	var validaRespuesta = function(respuesta)
	{
		...
		consumeServicios(2, validaRespuesta, function(data)
		{
			...
			$("#mensaje").html(data.correcto ? "Respuesta Correcta" : "Respuesta Incorrecta")
							...
							contPregunta++;
						 	...
						 	else
						 	{
						 		swal(
						 		{
						 			...
						 			text: "Se acabaron las preguntas",
						 		...
						 		function()
						 		{
						 			swal({title: "Cargando Preguntas",   text: "Recargando página",   timer: 500,   showConfirmButton: false });
						 			location.reload();
						 		});
						 	}
						});
